...
// GCPKCCManagedClusterTemplateResource describes the data needed to create a GCPKCCManagedCluster from a template.
type GCPKCCManagedClusterTemplateResource struct {
	Spec GCPKCCManagedClusterSpec `json:"spec"`
}
...
// GCPKCCManagedClusterTemplateList contains a list of GCPKCCManagedClusterTemplate.
