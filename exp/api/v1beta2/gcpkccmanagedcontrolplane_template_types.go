...
// GCPKCCManagedControlPlaneTemplateList contains a list of GCPKCCManagedControlPlaneTemplates.
...
// GCPKCCManagedControlPlaneTemplateResource describes the data needed to create an GCPKCCManagedControlPlane from a template.
type GCPKCCManagedControlPlaneTemplateResource struct {
	Spec GCPKCCManagedControlPlaneTemplateResourceSpec `json:"spec"`
}
